		...
		<table class="table">
			...
			<tbody>
				...
				while ($res = mysqli_fetch_array($result)) {
					...
					echo "<td>" . $res['dept'] . "</td>";
					echo "<td><a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"details.php?id=$res[id]\">Details</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td></tr>";
				}
				?>
			</tbody>
		</table>
